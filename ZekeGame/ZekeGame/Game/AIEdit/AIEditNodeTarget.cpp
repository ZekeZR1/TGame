...
bool AIEditNodeTarget::Start()
{
	...
	m_fonts[0]->Init(L"じぶん", { m_fontpos }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
	m_fontpos.y -= 55.f;
	m_fonts[1]->Init(L"みかた", { m_fontpos }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
	m_fontpos.x += 20.f;
	m_fontpos.y -= 55.f;
	m_fonts[2]->Init(L"てき", { m_fontpos }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
