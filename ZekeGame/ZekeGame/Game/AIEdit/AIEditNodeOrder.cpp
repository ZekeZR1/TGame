...
void AIEditNodeOrder::Fonts()
{
	...
	if (m_aieditnodetechnique != nullptr) {
		...
		if (m_aieditnodetechnique->Gettechnique() == 500) {
			m_fonts[4]->Init(L"こうげき", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 501) {
			m_fonts[4]->Init(L"にげる", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 502) {
			m_fonts[4]->Init(L"ついせき", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 503) {
			m_fonts[4]->Init(L"まもる", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 504) {
			m_fonts[4]->Init(L"かいふく", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 505) {
			m_fonts[4]->Init(L"とくしゅ１", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
		if (m_aieditnodetechnique->Gettechnique() == 506) {
			m_fonts[4]->Init(L"とくしゅ２", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
		}
	}
	...
	if (m_aieditnodeabnormalstate != nullptr) {
		...
		if (m_aieditnodeabnormalstate->GetAbnormal() == 600) {
			m_fonts[5]->Init(L"どく", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
		}
		if (m_aieditnodeabnormalstate->GetAbnormal() == 601) {
			m_fonts[5]->Init(L"やけど", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
		}
		if (m_aieditnodeabnormalstate->GetAbnormal() == 602) {
			m_fonts[5]->Init(L"こおり", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
		}
		if (m_aieditnodeabnormalstate->GetAbnormal() == 603) {
			m_fonts[5]->Init(L"まひ", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
		}
	}
