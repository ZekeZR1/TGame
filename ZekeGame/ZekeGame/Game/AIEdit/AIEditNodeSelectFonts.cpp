...
void AIEditNodeSelectFonts::Update()
{
	...
	if (m_aieditnodetarget != nullptr) {
		if (m_aieditnodetarget->Getfonttarget() == true && target == true) {
			...
			if (m_aieditnodetarget->GetTarget() == 100) {
				m_fonts[0]->Init(L"じぶん", { m_fontpos1 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetarget->GetTarget() == 101) {
				m_fonts[0]->Init(L"みかた", { m_fontpos1 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetarget->GetTarget() == 102) {
				m_fonts[0]->Init(L"てき", { m_fontpos1 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			target = false;
		}
	}
	...
	if (m_aieditnode != nullptr) {
		if (m_aieditnode->Getnodefont() == true && node == true) {
			...
			m_fontpos2.x = m_pos.x - 60;
			m_fontpos2.y = m_pos.y + 360;
			if (m_aieditnode->GetNode() == 200) {
				m_fonts[1]->Init(L"のHPが", { m_fontpos2 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnode->GetNode() == 201) {
				m_fonts[1]->Init(L"のMPが", { m_fontpos2 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			node = false;
		}
	}
	...
	if (m_aieditnodeinequ != nullptr) {
		if (m_aieditnodeinequ->Getinequfont() == true && inequ == true) {
			...
			m_fontpos3.x = m_pos.x + 225;
			m_fontpos3.y = m_pos.y + 360;
			if (m_aieditnodeinequ->GetInequ() == 300) {
				m_fonts[2]->Init(L"以上", { m_fontpos3 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodeinequ->GetInequ() == 301) {
				m_fonts[2]->Init(L"以下", { m_fontpos3 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			inequ = false;
		}
	}
	...
	if (m_aieditnodetechnique != nullptr) {
		if (m_aieditnodetechnique->Gettechniquefont() == true && technique == true) {
			...
			if (m_aieditnodetechnique->Gettechnique() == 500) {
				m_fonts[4]->Init(L"　　　に　こうげき", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 501) {
				m_fonts[4]->Init(L"ーーーにげる", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 502) {
				m_fonts[4]->Init(L"　　　を　ついせき", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 503) {
				m_fonts[4]->Init(L"ーーーまもる", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 504) {
				m_fonts[4]->Init(L"　　　を　かいふく", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 505) {
				m_fonts[4]->Init(L"　　　に　とくしゅ１", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
			if (m_aieditnodetechnique->Gettechnique() == 506) {
				m_fonts[4]->Init(L"　　　に　とくしゅ２", { m_fontpos5 }, 0.0, CVector4::White, 0.9, { 0.0,0.0 });
			}
	...
	if (m_aieditnodeabnormalstate != nullptr) {
		if (m_aieditnodeabnormalstate->Getabnormalfont() == true && abnormal == true) {
			...
			m_fontpos6.x = m_pos.x - 60;
			m_fontpos6.y = m_pos.y + 360;
			if (m_aieditnodeabnormalstate->GetAbnormal() == 600) {
				m_fonts[5]->Init(L"がどく", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
			}
			if (m_aieditnodeabnormalstate->GetAbnormal() == 601) {
				m_fonts[5]->Init(L"がやけど", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
			}
			if (m_aieditnodeabnormalstate->GetAbnormal() == 602) {
				m_fonts[5]->Init(L"がこおり", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
			}
			if (m_aieditnodeabnormalstate->GetAbnormal() == 603) {
				m_fonts[5]->Init(L"がまひ", { m_fontpos6 }, 0.0, CVector4::White, 1.0, { 0.0,0.0 });
			}
