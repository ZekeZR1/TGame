...
bool Act_Blizzard::Action(Monster* me) {
	...
	if (m_first) {
		...
		m_cBeam.InitAbnormalStateInfo(L"Assets/effect/KOTIKOTI.efk",ACTEffectGrant::State::enHardCC, m_DoTEndTime,m_grantAbsTime);
		m_cBeam.Fire(me, m_target, L"Assets/effect/briza.efk", L"Assets/sound/bom.wav", laserRange,m_damage);
		m_first = false;
	}
